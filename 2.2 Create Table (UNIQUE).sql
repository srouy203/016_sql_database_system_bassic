/*		create table.sql
		...
		ជួរឈរទី ២ Coursename ជាឃ្លាមានអក្សរច្រើនបំផុតត្រឹម ៥០ តួនិងចាំបាច់ត្រូវមាន , តម្លៃរបស់វាមិនដូចគ្នា
		ជួរឈរទី ៣ Abbreviation ជាឃ្លាមានប្រវែងស្មើគ្នាគឺ៣តួរ និងចាំបាច់ត្រូវមាន, តម្លៃរបស់វាមិនដូចគ្នា
